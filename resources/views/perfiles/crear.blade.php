    ...
    <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
        <div class='max-w-md mx-auto space-y-6'>
            ...
            <form action="{{route('perfiles.store')}}" method="POST">
                ...
                <input type="text" name="cargo" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
                <label class="uppercase text-sm font-bold opacity-70">Biografia</label>
                <input type="text" name="biografia" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded">
